...
<body>
<table class="style">
    <caption class="heading">Autos</caption>
    <c:if test="${autosCount > 0}">
        <tr>
            <th class="left-side">№</th>
            <th style="width: 100%">vin</th>
            <th>year</th>
            <th>brand</th>
            <th>status</th>
    ...
    <tr>
        <td colspan="7" class="left-side link right-side">
            <a style="margin-right: 70px; font-size: 100%" href="<c:url value="/add"/>">
                <span class="icon icon-add"></span>Add new auto
            </a>
            ...
            <span style="margin-left: 70px; font-size: 120%">Total number Of autos: ${autosCount}</span>
        </td>
    </tr>
</table>
</body>
